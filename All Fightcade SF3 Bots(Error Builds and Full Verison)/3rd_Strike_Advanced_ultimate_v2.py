...
CAL_LOG_PATH = "/home/bemo9000/.3rd_strike_calibration.json"
GHOST_FILE_LOG_PATH ="/home/bemo9000/.ghost_patterns.json"
...
def monitor_loop(window_id, deadzone=0.25):
    ...
    try:
        while True:
            ...
            info_q.append(info)
            # print status
            print("n[MATCH] {} (You) vs {} (Opp)".format(info.p1_name, info.p2_name))
